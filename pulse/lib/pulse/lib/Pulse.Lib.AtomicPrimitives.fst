...
ghost fn make_persistent_impl (#a:Type0) (r : B.box a) (#v : erased a) (#p:perm)
  requires B.pts_to r #p v
  ensures persistent_pts_to r (reveal v)
{ fold (persistent_pts_to r (reveal v)) }

let make_persistent = make_persistent_impl

ghost fn dup_persistent_impl (#a:Type0) (r : B.box a) (#v : a)
  requires persistent_pts_to r v
...
let dup_persistent = dup_persistent_impl
